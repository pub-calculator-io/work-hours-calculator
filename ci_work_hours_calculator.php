...
Version: 1.0.0
Author: Work Hours Calculator / www.calculator.io
...
if (!function_exists('add_shortcode')) return "No direct call for Work Hours Calculator by www.calculator.io";

function display_calcio_ci_work_hours_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_work_hours_calculator', 'display_calcio_ci_work_hours_calculator' );